...
export const changeTheme = (
    ...
    setTheme: React.Dispatch<React.SetStateAction<null | typeof Light | typeof Dark>>,
...
export const saveTheme = async (preferedTheme: User["prefered_theme"], user: User, setUser: React.Dispatch<React.SetStateAction<User>>) => {
    await API.$users_prefered_theme.user_prefered_theme({ prefered_theme: preferedTheme, user: user.email })
