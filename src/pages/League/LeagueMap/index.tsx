...
export const LeagueMapStack = ({ route }) => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        ...
        name={screens.LeagueMap.name as keyof RootStackParamList}
        options={{
          headerShown: false,
        }}
        component={LeagueMap} />
...
const LeagueMap: React.FC<ScreenProps<'LeagueMap'>> = ({ navigation, route }) => {
