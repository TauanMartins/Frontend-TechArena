...
const FriendsSolicitations = ({ friendsSolicitationsReceived, friendsSolicitationsRequested, search }) => {
    ...
    // -----------------------------------------------------
    const combinedData = [
        ...friendsSolicitationsReceived.map((item: Friend) => ({ ...item, type: 'received' })),
        ...friendsSolicitationsRequested.map((item: Friend) => ({ ...item, type: 'requested' })),
    ];
...
export default FriendsSolicitations;